...
export function ProductFormModal({
  ...
  const categories = [
    { label: t('products.categories.electronics'), value: t('products.categories.electronics') },
    { label: t('products.categories.clothing'), value: t('products.categories.clothing') },
    { label: t('products.categories.food'), value: t('products.categories.food') },
    { label: t('products.categories.home'), value: t('products.categories.home') },
    { label: t('products.categories.sports'), value: t('products.categories.sports') },
  ]
  ...
  const handleChange = (field: keyof Product) => (
    e: React.ChangeEvent<HTMLInputElement> | { target: { value: string | number } }
  ) => {
